...
public class Activity003B5 extends ButtonsActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity003b5);

    }

    public void onQ5Click(View view) {
        TextView output = findViewById(R.id.a3b5_output);
        TextView answer = findViewById(R.id.a3b5_answer);
        LinearLayout input_layout = findViewById(R.id.a3b5_input);
        LinearLayout input_layout2 = findViewById(R.id.a3b5_input2);
        TextView input = findViewById(R.id.a3b5_edit_text);
        TextView input2 = findViewById(R.id.a3b5_edit_text2);
        Button submit = findViewById(R.id.a3b5_send_btn);
        ...
        if (question_text != "") {
            ...
            if (question == display) {
                ...
                ((TextView)view).setBackgroundColor(0xFFFF9476);
                if (question == 5) {
                    input_layout.setVisibility(View.GONE);
                } else if (question == 4) {
    ...
    public void onQ5Send(View view) {
        int i, result;
